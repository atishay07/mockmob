  ...
  return (
    <div className="view relative min-h-screen overflow-hidden bg-[#070807]">
      ...
      <div className="container-wide relative z-10 px-5 pb-10 pt-[108px]">
        <section className="mx-auto grid min-w-0 max-w-5xl grid-cols-1 items-center gap-10 lg:grid-cols-2">
          <div className="min-w-0">
            ...
            <h1 className="display-lg mb-4 max-w-[11ch] break-words sm:max-w-lg">
