...
export function SignupCard({ mode = 'signup' }) {
  ...
  return (
    <div className="glass w-full max-w-md border border-white/10 bg-[rgba(255,255,255,0.02)] p-6 text-center md:p-7">
      ...
      <LiquidGlassButton variant="volt" size="lg" className="w-full justify-center" onClick={handleGoogleUi} disabled={googleLoading || emailLoading}>
